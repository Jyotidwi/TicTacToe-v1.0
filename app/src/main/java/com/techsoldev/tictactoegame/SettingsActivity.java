...
public class SettingsActivity extends AppCompatActivity {
       ...
       soundSwitch.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
        ...
        feedback.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
               ...
               /*
                try {
                    Intent intent = new Intent(Intent.ACTION_VIEW, Uri.parse("mailto:" + "jyotsnanand.jnd2000@gmail.com"));
    ...
    public void composeEmail( String subject) {
        ...
        intent.setData(Uri.parse("mailto:jyotsnanand.jnd2000@gmail.com")); // only email apps should handle this
